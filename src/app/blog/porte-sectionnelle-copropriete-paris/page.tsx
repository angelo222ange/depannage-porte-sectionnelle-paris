...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://porte-sectionnelle-paris.fr/blog/porte-sectionnelle-copropriete-paris/" },
  openGraph: {
    title: "Porte Sectionnelle Copropriete Paris | Guide 2026",
    description: "Guide installation porte sectionnelle copropriete Paris : AG, syndic, normes, couts partages.",
    url: "https://porte-sectionnelle-paris.fr/blog/porte-sectionnelle-copropriete-paris/",
  ...
  return (
    <>
      ...
      <BlogArticleLayout>
          ...
          <p style={{ marginBottom: "20px" }}>
            Chez <strong>Porte Sectionnelle Paris</strong>, nous accompagnons les coproprietes de A a Z : etude technique, devis detaille pour le syndic, intervention coordonnee et suivi de maintenance. Nous intervenons pour l&apos;<a href="/installation-porte-sectionnelle-paris/" style={{ color: "#FF6333", fontWeight: 600 }}>installation</a>, le <a href="/depannage-porte-sectionnelle-paris/" style={{ color: "#FF6333", fontWeight: 600 }}>depannage en urgence</a> et l&apos;<a href="/entretien-porte-sectionnelle-paris/" style={{ color: "#FF6333", fontWeight: 600 }}>entretien sous contrat</a> dans toutes les coproprietes parisiennes.
          </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        image: "https://porte-sectionnelle-paris.fr/images/portes/porte-sectionnelle-automatique.webp",
      }) }} />
